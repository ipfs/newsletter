...
@dignifiedquire's work on [karma-peer](https://github.com/dignifiedquire/karma-peer) means that it now has the ability to dynamically launch browsers, which will help @diasdavid, and hopefully more people, to write better tests for P2P browser applications. See an example of some tests, here: [Example Tests](https://github.com/dignifiedquire/karma-peer/blob/master/test/index.spec.js). You can also see the reasons that lead to this module and the original tool to test P2P browser applications, [here](https://github.com/diasdavid/piri-piri#why-does-it-exist).
