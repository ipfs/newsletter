...
![webui](https://ipfs.io/ipfs/QmP5CaPvrCT3CivuWesM2gT4K8sELdh3Hr3pJZcLaaze82/008_webui.gif)
...
### [ipfs-firefox-addon](https://github.com/lidel/ipfs-firefox-addon)

There were some changes in [ipfs-firefox-addon](https://github.com/lidel/ipfs-firefox-addon) since it was mentioned in Weekly No.3 (v1.4.2).
...
The 1.5.x series brings various UX improvements such as Realtime Status and Diagnostics, along with experimental features that can be enabled on the Preferences screen. Check the full list [at Github](https://github.com/lidel/ipfs-firefox-addon#features). Feature requests and bug reports [are welcome](https://github.com/lidel/ipfs-firefox-addon/issues)!
