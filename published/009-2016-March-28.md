...
Hydrus is a personal booru-style media tagger that can import files and tags from your hard drive and popular websites. Content can be shared with other users via user-run servers. Over the last 10 or so updates, the developer for this has been implementing support for IPFS, and now has quite a bit of IPFS related features.
