...
https://github.com/ipfs/docs/labels/help%20wanted

### IPFS shoutout in the Berty Weekly!
Guilhem and Antoine found the best approach to allow gomobile-ipfs to handle incoming and outgoing connections with a given peer using streams. We’ll extend the CoreAPI with two endpoints:  * One that registers a handler for a given protocolID that will return a Unix Domain Socket for any incoming connection * Another one that allows dialing a peerID and returns a Unix Domain Socket
https://berty.tech/newsletter/weekly-21/
